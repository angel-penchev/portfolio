    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            'absolute left-1/2 top-1/2 flex h-full w-full items-start justify-start overflow-hidden rounded-2xl border border-white/[0.5] bg-black p-6 shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 group-hover/pin:border-white/[0.75]',
            className,
          )}
        >
          {children}
  ...
  return (
    <motion.div className="pointer-events-none z-[60] flex h-full w-full items-center justify-center opacity-0 transition duration-500 group-hover/pin:opacity-100">
      <div className="inset-0 -mt-7 h-full w-full flex-none">
        ...
        <>
          <motion.div className="absolute bottom-1/2 right-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-cyan-500 blur-[2px] group-hover/pin:h-1/2" />
          <motion.div className="absolute bottom-1/2 right-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-cyan-500 group-hover/pin:h-1/2" />
