...
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={cn('relative h-full w-full bg-white', containerClassName)} style={style}>
...
const ShaderMaterial = ({
  ...
  const getUniforms = (): {
    [key: string]: { value: number | number[] | THREE.Vector2 | THREE.Vector3 | THREE.Vector3[]; type?: string };
  } => {
